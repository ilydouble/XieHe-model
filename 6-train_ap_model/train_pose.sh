...
选项:
  ...
  --data    <yaml>       数据配置 (默认: pose_data.yaml)
...
示例:
  ...
  $0 --best --device 0,1
  $0 --roi-mixed --imgsz 800 --name roi_mixed_v1
EOF
}
...
while [[ $# -gt 0 ]]; do
  case $1 in
    ...
    --roi-mixed)
      DATA="pose_data_roi_mixed.yaml"; AUGMENTATION_PROFILE="roi_low"; NAME="roi_mixed_v1"; shift ;;
